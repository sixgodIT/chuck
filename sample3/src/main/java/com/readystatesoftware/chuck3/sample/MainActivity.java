 ...
 */
package com.readystatesoftware.chuck3.sample;
...
import com.readystatesoftware.chuck3.ChuckInterceptor;
...
public class MainActivity extends AppCompatActivity {
    ...
    private OkHttpClient getClient(Context context) {
        return new OkHttpClient.Builder()
                ...
                .addInterceptor(new ChuckInterceptor(context, BuildConfig.APPLICATION_ID))
